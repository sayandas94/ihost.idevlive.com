	...
	<div class="container">
		<div class="row">
			<div class="col s12 m6 l5">
				...
				<br><br>
				<p>Enjoy an exclusive <a href="{{ url('refund-policy') }}" class="primary-text semi-bold">30 days money back</a> gurantee on all hosting purchases.</p>
			</div>
				...
				<table class="features-table">
					<tbody>
						...
						<tr>
							...
							<td>
								<p>
									<span class="semi-bold">Uptime Gurantee</span>
									<br>
					...
					<tbody>
						...
						<tr>
							<td>
								...
								{{-- <i class="material-symbols-rounded primary-text">smart_display</i> --}}
							</td>
							<td>
								<p>
...
<section class="center-align">
	<div class="container">
		...
		<div class="features-wrapper">
			...
			<div class="card-panel features-card" style="align-items: center;">
				<img src="{{ asset('images/icons/reliable-servers.svg') }}" alt="cheap website hosting" width="30" loading="lazy">
